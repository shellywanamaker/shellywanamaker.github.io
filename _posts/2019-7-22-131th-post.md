...
- v074 (18scaffolds; not using BLAST to call genes use the gff maker generates)
	...
	- maybe take Steven's data and do the same analysis to compare coverage with [my previous analysis of v70, v71 and v73](https://shellytrigg.github.io/42th-post/); or [do the scaffold coverage analysis I previously did](https://github.com/shellytrigg/Shelly_Pgenerosa/blob/master/analyses/MethylKit_JuviPgenr_diffpH/GeoduckSubsetAlignmentTest.md) but on v074. Then see how things map
