...
2. Start on my [first task](https://github.com/shellywanamaker/C_virginica/blob/master/2018-09-18_IntroToBismark.ipynb) to familiarize with the lab's general DNA methylation analysis pipeline for PE bisulfite sequencing data  
